...
router.get('/api/contacto/', function(req, res, next) {
...
router.get('/api/contacto/:id', function(req, res, next) {
...
router.put('/api/contacto/:idContacto', function(req, res, next){
...
router.delete('/api/contacto/:idContacto', function(req, res, next){
